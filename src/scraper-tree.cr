    ...
    Organization.new(
      ...
      scrapers: [
        ...
        BalikesirUni.new(
          ...
          target: URI.parse "http://www.balikesir.edu.tr/site/tum-birim-duyuru/ogrenci-isleri-daire-baskanligi-6",
        ),
        BalikesirUni.new(
          path: "arch",
        ...
        BalikesirUni.new(
          ...
          target: URI.parse "http://www.balikesir.edu.tr/site/tum-birim-duyuru/uluslararasi-iliskiler-arastirma-ve-uygulama-merkezi-129938",
        ),
      ] of BaseScraper,
    ),
  ] of Organization
